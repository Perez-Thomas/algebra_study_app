...
signIn.addEventListener("click", function (event) {
  ...
  if (login_email === "email" && login_password === "password") {
    ...
    alert(
      "Incorrect 'username' and/or 'password', contact your teacher to continue. Or type 'email' in the email section and 'password' in the password section."
    );
  }
});
...
//   if (e.keyCode === 13 || document.querySelector("sign-in-button").on) {
//     document.querySelector(".popup").classList.remove("active");
//     document.querySelector(".main-app");
//     document.setAttribute("style", "filter: blur(0px)");
//   } else {
//     alert(
//       "Incorrect 'username' and/or 'password', contact your teacher to continue."
//     );
//   }
// };

// document.querySelector(".sign-in-button").onkeydown = function (e) {
//   if (e.keyCode == 13) {
//     document.querySelector(".popup").classList.remove("active");
//     document.querySelector(".main-app");
//     document.setAttribute("style", "filter: blur(0px)");
...
const modelingExpressionsContainer = document.getElementById(
  "modeling-expressions"
);
const orderOfOperationsContainer = document.getElementById(
  "order-of-operations"
);
const evaluatingExpressionsContainer = document.getElementById(
...
const myQuestions = [
  ...
  //   answers: {
  //     a: " one-half the sum of x and 4",
  //     b: " the difference of one-half n and 3",
  //     c: " double the sum of x and 4",
  //     d: "one-half n subtracted from 3",
  //   },
  //   correctAnswer: "c",
  ...
  // {
  //   question:
  //     " What is the first step in simplifying the expression (2 - 3 * 4 + 5) &#xB2",
  //   answers: {
  //     a: "square 5",
  //     b: "add 4 and 5",
  //     c: "subtract 3 from 2",
  ...
  // {
  //   question:
  //     "#3 If the expression 3-4&#xB2 + <sup>6</sup>&frasl;<sub>2</sub>  is evaluated, what would be done last?",
  //   answers: {
  //     a: "subtracting",
  //     b: "squaring",
  //     c: "adding",
  ...
  // {
  //   question:
  //     "#11 What is the value of | <sup>4(-6)+18</sup>&frasl;<sub>4!</sub>| ?",
  //   answers: {
  //     a: "1/4",
  //     b: "-1/4",
  //     c: "12",
  ...
  // {
  //   question:
  //     " The value of the expression  6! + <sup>5!(3!)</sup>&frasl;<sub>4!</sub> - 10  is",
  //   answers: {
  //     a: "50",
  //     b: "102",
  //     c: "740",
  ...
  // {
  //   question: "What is the value of the expression |-5x + 12| when x = 5?",
  //   answers: {
  //     a: "-13",
  //     b: "37",
  //     c: "13",
...
function getNbOccur(subTopic, myQuestions) {
  ...
  for (var i = 0; i < myQuestions.length; i++) {
    if ("subTopic" in myQuestions[i] && myQuestions[i].subTopic === subTopic)
      occurs++;
  }
  return occurs;
}
...
function showResults() {
  ...
  myQuestions.forEach((currentQuestion, questionNumber) => {
    ...
    if (
      currentQuestion.subTopic === "modeling-expressions" &&
      userAnswer === currentQuestion.correctAnswer
    ) {
      modelingExpressionsCorrect++;
    } else if (
      currentQuestion.subTopic === "order-of-operations" &&
      userAnswer === currentQuestion.correctAnswer
    ) {
      orderOfOperationsCorrect++;
    } else if (
      currentQuestion.subTopic === "evaluating-expressions" &&
      userAnswer === currentQuestion.correctAnswer
    ) {
  ...
  let percentageResult =
    Math.round((numCorrect / myQuestions.length) * 100) + "%";
  percentageContainer.innerHTML = "Total Percentage: " + percentageResult;

  // numbers correct per subTopic
  modelingExpressionsContainer.innerHTML =
    "Modeling Expressions: " +
    modelingExpressionsCorrect +
    " out of " +
    getNbOccur("modeling-expressions", myQuestions) +
    " or " +
    Math.round(
      (modelingExpressionsCorrect /
        getNbOccur("modeling-expressions", myQuestions)) *
  ...
  orderOfOperationsContainer.innerHTML =
    "Order of Operations: " +
    orderOfOperationsCorrect +
    " out of " +
    getNbOccur("order-of-operations", myQuestions) +
    " or " +
    Math.round(
      (orderOfOperationsCorrect /
        getNbOccur("order-of-operations", myQuestions)) *
  ...
  evaluatingExpressionsContainer.innerHTML =
    "Evaluating Expressions: " +
    evaluatingExpressionsCorrect +
    " out of " +
    getNbOccur("evaluating-expressions", myQuestions) +
    " or " +
    Math.round(
      (evaluatingExpressionsCorrect /
        getNbOccur("evaluating-expressions", myQuestions)) *
